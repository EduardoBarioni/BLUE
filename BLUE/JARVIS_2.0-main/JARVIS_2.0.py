...
def SomIncial():
    p = vlc.MediaPlayer("/home/user/AGVS repository/BLUE/JARVIS_2.0-main/StartSound.mp3")
    p.play()

SomIncial()

def SomCarregamento():
    p = vlc.MediaPlayer("/home/user/AGVS repository/BLUE/JARVIS_2.0-main/AI.mp3")
    p.play()

if not os.path.exists("/home/user/AGVS repository/BLUE/JARVIS_2.0-main/Model-PTBR"):
...
model = Model("/home/user/AGVS repository/BLUE/JARVIS_2.0-main/Model-PTBR")
