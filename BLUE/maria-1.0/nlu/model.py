...
data = yaml.safe_load(open('/home/user/AGVS repository/BLUE/maria-1.0/nlu/train.yml', 'r', encoding='utf-8').read())
...
input_data = np.zeros((len(inputs), 48, 256), dtype='float32')
